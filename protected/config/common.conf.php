...
$config['SITE_PATH'] = realpath('..').'/emap/';
...
$config['LOG_PATH'] = $config['SITE_PATH'] . 'protected/log/';
 ...
 */ $config['AUTOLOAD'] = array(
                            ...
                            'class', 'model', 'module/geo/controller', 'module/geo/config/layer', 'module/geo/class', 'module/geo/model',
