...
$route['get']['/login'] = array('DesktopController', 'login');
$route['get']['/mobile'] = array('MobileController', 'index');
$route['get']['/mobile/login'] = array('MobileController', 'login');

$route['get']['/ib'] = array('EnodController', 'index');

$route['get']['/create/ftinput/:client/:owner'] = array('FieldTechController', 'createinput');
$route['get']['/get/ftinput/:client'] = array('FieldTechController','retrieveInput'); 
$route['get']['/modify/ftinput/:client'] = array('FieldTechController','modifyinput');
$route['get']['/delete/ftinput/:client'] = array('FieldTechController','deleteInput');
 
$route['get']['/get/ftinput_datagrid/:client'] = array('FieldTechController','retrieveInput_datagrid'); 


//
// Authentication API Controller
//
$route['post']['/auth/login'] = array('AuthController', 'login');
$route['post']['/auth/register'] = array('AuthController', 'register');
$route['post']['/auth/changepassword'] = array('AuthController', 'changepassword');
$route['post']['/auth/forgotpassword'] = array('AuthController', 'forgotpassword');
$route['*']['/auth/logout'] = array('AuthController', 'logout');

//Users Controller
$route['post']['/users'] = array('UsersController', 'update');

//Legend Controller
$route['get']['/legend'] = array('LegendController', 'getLegend');
