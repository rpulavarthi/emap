...
var init = function (onSelectFeatureFunction) {
  ...
  //  sprintersLayer.addFeatures(sprinters);
	...
	var wms = new OpenLayers.Layer.WMS( "Pies",
		"geo/wms/pie", {layers: 'V2R2_CDMA'} , 
		{
			isBaseLayer : false,
			opacity: 1,
			singleTile: true,
	...
	var kml = new OpenLayers.Layer.Vector("Clusters", {
		projection: map.displayProjection,
		
		strategies: [new OpenLayers.Strategy.BBOX({resFactor:1, ratio:1.5})],
		protocol: new OpenLayers.Protocol.HTTP({
			url: "geo/kml/site/cluster/V2R2_CDMA",
	...
	map.addLayers([kml,wms]);	

	map.setCenter(new OpenLayers.LonLat(-117.1266, 32.74).transform(map.displayProjection, map.projection), 12);
